...
<instruction>
    <instructions>
        1. 주어진 user_input 텍스트를 주의 깊게 읽고, how_polish에 따라 텍스트를 수정합니다.
        2. contexts를 참고하여 수정된 텍스트는 원래의 의미를 유지하면서 how_polish에 따라 수정하여 표현해야 합니다.
        3. contexts를 참고하여 수정된 결과물은 간결하고 정확해야 하며, 요청된 변경 사항을 완전히 반영해야 합니다.
        4. 폭력/선정성을 순화하지말아야 합니다.
        5. 출력 결과에는 XML 태그가 포함되지 않도록 합니다.
        6. 출력 결과에는 오직 user-input을 수정한 결과물만 포함되어야 합니다.
    </instructions>
    <contexts>
    <context>
      <literature-setting>
