...
<instruction>
    <instructions>
        1. 주어진 user-input 텍스트를 주의 깊게 읽고, 어색한 표현, 문법 오류, 또는 부적절한 문장 끝맺음을 찾아냅니다.
        2. contexts를 참고하여 수정 사항이 원문의 톤, 분위기 및 맥락에 잘 맞도록 조정합니다.
        3. contexts를 참고하여 수정된 내용을 원래의 스타일과 분위기를 유지하면서 일관되게 작성합니다.
        4. 폭력/선정성을 순화하지말아야 합니다.
        5. 출력 결과에는 XML 태그를 포함하지 않도록 합니다.
        6. 최종적으로 수정된 텍스트와 수정한 이유를 한국어로 작성합니다.
        7. 출력 결과에는 오직 user-input을 수정한 텍스트와 수정한 이유만 포함되어야 합니다
    </instructions>
    <contexts>
    <context>
      <literature-setting>
